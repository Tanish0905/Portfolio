...
const ContactPage = () => {
  ...
  try {
    const response = await fetch("https://formsubmit.co/tanishpadvekar9@gmail.com", {
      method: "POST",
  ...
  return (
    <>
      ...
      <div
        ...
        id="Contact"
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[100%] 2xl:grid-cols-[100%] gap-12">
          <div
            data-aos="fade-right"
