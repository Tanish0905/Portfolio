...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/tanish0905" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/tanish-padvekar-4b350122b/" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-[5%] py-3 sm:px-6 sm:py-4 lg:px-[5%] lg:py-[3%] min-h-screen">
